...
const s_stylePath = '/site/comment-widget-dark/comment-widget-dark.css'; // The path to the CSS file for the widget
const s_formId = '1FAIpQLSfDrzuyGz0H5UzbWzuqjYEIUXZ_hVyLG0eXh9RPMPxyjn1wMw';
const s_nameId = '97058247';
const s_websiteId = '1150359047';
const s_textId = '279388889';
const s_pageId = '1023415679';
const s_replyId = '276856803';
const s_sheetId = '1I6F2KHPZIHFpMK-JqLpM30CyZq1bs4h7mxKnYfrQ6S8';
...
const s_widgetTitle = 'Saturn icon to control';
...
const v_formHtml = `
    ...
    <img src="./img/buttons/signguest.gif" alt="Sign Guestbook">
